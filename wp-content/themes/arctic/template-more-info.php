...
$items      = array(
	...
	array(
		...
		'url'         => home_url( '/podpora/#caste-dotazy' ),
	),
	array(
		'id'          => 'reference',
		'title'       => 'Reference',
...
<main id="<?php echo sanitize_title( esc_attr_x( 'content', 'anchor', 'baspa' ) ); ?>" class="f-main f-main--figma-page f-main--more-info">
	<section class="f-section f-section--info-cards" aria-label="<?php echo esc_attr__( 'Další informace Arctic Spas', 'baspa' ); ?>" data-content-source="figma-wireframe-navigation-hub">
			...
			<div class="f-figma-card-grid f-figma-card-grid--info">
				<?php foreach ( $items as $item ) { ?>
					<a id="<?php echo esc_attr( $item['id'] ); ?>"
					   ...
					   data-content-source="figma-wireframe-navigation-hub"
