...
if ( !function_exists( 'baspa_accessories_taxonomy_register' ) ) {
	 ...
	 * @return void
	 */
	function baspa_accessories_taxonomy_register(): void {

		/**
		 * Category
		 */
		register_taxonomy( 'accessory-category', 'accessory', array(
			'labels'       => array(
				'name'                       => esc_html_x( 'Accessory Categories', 'taxonomy', 'baspa' ),
			...
			'label'        => esc_html_x( 'Accessory Categories', 'taxonomy', 'baspa' ),
			'public'       => false,
			'show_ui'      => true,
			'show_in_menu' => true,
			'show_in_rest' => true,
			...
			'has_archive'  => true,
			'rewrite'      => array(
				'slug'         => esc_html_x( 'accessories', 'taxonomy', 'baspa' ),
				'hierarchical' => true,
				'with_front'   => false,
			),
		) );
	...
	add_action( 'init', 'baspa_accessories_taxonomy_register' );
