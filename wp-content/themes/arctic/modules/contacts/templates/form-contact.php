...
if ( isset( $_POST[ 'f-form--submitted' ] ) ) {
	...
	<form id="<?php echo sanitize_title( esc_attr_x( 'form-contact', 'anchor', 'baspa' ) ); ?>"
	      class="f-form--contact f-form js-form" method="post"
	      action="<?php echo esc_url( get_the_permalink() . '#' . _x( 'form-contact', 'anchor', 'baspa' ) ); ?>"
		...
		<input type="hidden" name="f-form-name" value="<?php echo esc_attr__( 'Kontakt', 'baspa' ); ?>">
