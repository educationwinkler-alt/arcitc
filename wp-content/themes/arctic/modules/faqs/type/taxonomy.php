...
if ( !function_exists( 'baspa_faqs_taxonomy_register' ) ) {
	 ...
	 * @return void
	 */
	function baspa_faqs_taxonomy_register(): void {
		...
		register_taxonomy( 'faq-category', 'faq', array(
			'labels'       => array(
				'name'                       => esc_html_x( 'FAQ Categories', 'taxonomy', 'baspa' ),
			...
			'label'        => esc_html_x( 'FAQ Categories', 'taxonomy', 'baspa' ),
			'public'       => true,
			'show_ui'      => true,
			'show_in_menu' => true,
			'show_in_rest' => true,
			...
			'has_archive'  => true,
			'rewrite'      => array(
				'slug'         => esc_html_x( 'faqs', 'taxonomy', 'baspa' ),
				'hierarchical' => true,
				'with_front'   => false,
			),
		) );
	...
	add_action( 'init', 'baspa_faqs_taxonomy_register' );
