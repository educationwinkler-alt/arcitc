...
- Migracni mapa je generovana prikazem `npm run migration:map` do `docs/migration-map.csv`. Posledni vystup ma 135 radku: 75 sloucenych redirectu, 27 downloadu k importu, 22 produktu, 5 vyrazenych produktu, 4 polozky sirsiho sortimentu a 2 hlavni stranky.
