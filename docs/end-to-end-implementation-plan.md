...
- Posledni overeni: `npm run visual:smoke` prosel po desktop Figma passu kategorie `Venkovni virivky Arctic Spas` a neodhalil externi browser requesty, `baspa.cz` requesty ani horizontalni overflow.
