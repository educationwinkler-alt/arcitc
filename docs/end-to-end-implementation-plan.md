...
- Automaticky Figma audit `npm run figma:audit` kontroluje HP/header/mobile top proti Figma souradnicim a zaroven hlida, ze logo, hero background, hero image a vyprodejovy banner berou Figma assety z `uploads/import/figma/`, ne WP crop ani stary Arctic vizual.
