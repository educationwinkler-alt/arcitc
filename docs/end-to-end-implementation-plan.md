...
- Posledni overeni: PHP lint upravenych sablon prosel, seed se propsal do lokalniho WordPressu, dlouhe hero CTA u `Další sortiment` nepretyka a `npm run visual:smoke` prosel bez externich requestu.
